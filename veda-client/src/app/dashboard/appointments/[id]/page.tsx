...
export default function ActiveConsultation() {
  ...
  const handleGeneratePDF = () => { setIsGenerating(true); setTimeout(() => { setIsGenerating(false); toast.success("Prescription PDF downloaded!"); }, 1500); };
        ...
        <form id="consultation-form" className="grid lg:grid-cols-12 gap-6 items-start pb-28 relative">
          ...
          <div className="lg:col-span-5 relative">
            <div className="sticky top-6 space-y-6">
              ...
              {/* Real-time Prescription Preview (Looks like paper) */}
              <div className="bg-white rounded-xl border border-slate-200 shadow-xl overflow-hidden aspect-[1/1.4] flex flex-col relative before:absolute before:inset-0 before:bg-[url('/watermark-logo.png')] before:bg-center before:bg-no-repeat before:opacity-5 before:pointer-events-none">
                ...
                <div className="p-6 flex-1 text-sm flex flex-col relative z-10 overflow-y-auto hide-scrollbar">
                  ...
                  {/* 🚀 NEW: Recommended Therapies in Preview */}
                  ...
                  <div className="mt-auto pt-10 flex justify-between items-end relative">
                    ...
                    <div className="flex flex-col items-center relative">
                      ...
                      <p className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">Reg. No: AY-29384</p>
                    </div>
                  </div>
